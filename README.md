...
- Dashboard: `./admin/`
- Guests data backend: `./admin/guests.html`
- Mobile homepage settings: `./admin/settings.html`
- First login: go to `settings.html` and set your own PIN in browser localStorage.
